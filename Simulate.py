...
def start_simulating():
    ...
    # Define output file
    output_file = open("log/G2OPT.csv", "w")
    ...
    for nb_run in range(3):
        ...
        temp = net.simulate(exp_type=experiment_type, exp_index=experiment_index, nb_run=nb_run, optimizer=g2opt, t=0, dead_time=0, file_name=file_name)
...
def resume_simulating():
    ...
    log_file    = "log/g2_opt_{}_{}_{}.csv".format(experiment_type, experiment_index, nb_run)
